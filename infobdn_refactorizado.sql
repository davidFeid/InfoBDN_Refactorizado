...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-02-2023 a las 10:50:54
...
INSERT INTO `cursos` (`codigo`, `nombre`, `descripcion`, `horas`, `fecha_inicio`, `fecha_final`, `foto`, `profesor`, `activo`) VALUES
(2, 'Programación Python', '¿Qué es Python? Si has llegado hasta aquí, es probable que ya tengas algunas nociones sobre programación, aunque no estés especializado en Python. Python es un lenguaje de programacióe alto nivel que se puede usar para prácticamente cualquier cosa, incluso existen videojuegos que emplean este lenguaje de programación', 26, '2022-10-18', '2023-02-25', 'views/css/assets/fotos/foto_2.jpg', '54785478y', 1),
(3, 'Programador Java', 'El mundo de internet, el comercio digital, la comunicación y el marketing está cambiando y modernizándose cada vez más, por eso es importante estar al día y saber adaptarse a las novedades en estos sectores.\r\n\r\nEn este contexto, cada vez es más necesario contar con un sitio web que cubra las necesidades de cada empresa, y este sitio web deben diseñarlo especialistas en programación.', 45, '2022-12-10', '2022-12-16', 'views/css/assets/fotos/foto_3.jpg', '54785478y', 1),
...
(9, 'Machine Learning', 'Como expertos en formación podemos ayudarte a encontrar el mejor curso de Machine learning que te permitirá dar un salto cualitativo en tu currículum.\r\n\r\nNo pierdas la oportunidad de formarte en las tecnologías que ya forman parte del presente en el sector de la programación y cuya demanda de profesionales especializados aumenta cada día. Encuentra con nuestra ayuda el curso de Machine learning perfecto para ti, que te permitirá dar un giro a tu futuro profesional.', 30, '2022-11-04', '2022-11-23', '../fotos_cursos/foto_9.jpg', '54785478y', 0),
(10, 'grafista de videojuego', 'El sector de los videojuegos está en claro auge, y uno de los puestos de trabajo más demandados y mejor valorados es el de grafista de videojuegos. Si te apasiona el mundo de las tecnologías esta puede ser una oportunidad única para que comiences a formarte en un área que te apasiona', 32, '2022-10-18', '2022-11-06', '../fotos_cursos/foto_10.jpg', '12345678t', 0),
(13, 'daw', 'nose', 4, '2022-11-19', '2022-11-20', '../fotos_cursos/foto_11.jpg', '54785478y', 0),
(14, 'nose', '4444', 4, '2023-02-05', '2023-02-22', 'nose', '12345678t', 1),
(15, 'victor', 'borbo', 4, '2023-02-08', '2023-02-10', 'views/css/assets/fotos/foto_vi', '12345678t', 1),
(16, 'albaro', 'aldawb', 4, '2023-02-08', '2023-02-09', 'views/css/assets/fotos/foto_albaro.jpg', '12345678t', 0);
...
INSERT INTO `profesores` (`dni`, `nombre`, `apellido`, `titulo_academico`, `foto`, `contraseña`, `activo`) VALUES
('11111111Ñ', 'ÑAÑ', 'ñpñ', 'ñññ', 'views/css/assets/fotos/foto_11111111Ñ.jpg', '21232f297a57a5a743894a0e4a801fc3', 1),
('12345678t', 'Raul', 'Murillo', 'Trigonometria 5', 'views/css/assets/fotos/foto_12345678t.jpg', '21232f297a57a5a743894a0e4a801fc3', 1),
('44444444L', 'lolo', 'lolo', 'o', 'views/css/assets/fotos/foto_44444444L.jpg', '21232f297a57a5a743894a0e4a801fc3', 0),
('54785478y', 'Iker', 'Romero', 'DAW', '/InfoBDN/fotos/foto_54785478y.jpg', '21232f297a57a5a743894a0e4a801fc3', 1),
('77777777r', 'yuli', 'nose', 'algo', 'nos', 'daw', 1),
('87654321t', 'Laura', 'Jaramillo', 'Ingeniera Aeronautica', '/InfoBDN/fotos/foto_87654321t.jpg', '21232f297a57a5a743894a0e4a801fc3', 0),
('88888888H', 'HUGoo', 'HUGA', 'ol', 'views/css/assets/fotos/foto_88888888H.jpg', '21232f297a57a5a743894a0e4a801fc3', 0);
